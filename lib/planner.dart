        ...
        child: Form(
          ...
          child: Card(
            child: Column(
              children: <Widget>[
                TextFormField(
                  decoration: const InputDecoration(hintText: "Disk to backup"),
                ...
                TextFormField(
                  decoration: const InputDecoration(hintText: "Save backup"),
                    ...
                    if (formkey.currentState!.validate()) {
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            content: Text("[$diskToBackup], [$backupToDisk], [${backupToDisk.substring(0, 3)}], [$dayToBackup], [${d.serialNumber.toString()}]"),
                          );
                        }
                      );
                      int a = checkSerial();
